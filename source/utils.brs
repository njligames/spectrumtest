...
Function getConstants(key as String) as String
    baseUrl = "https://cdn.churchofjesuschrist.org/mobile/GospelStream/v1/"
    collectionsBaseUrl = baseUrl + "collections/"

    map = {
        "HOME_URL" : baseUrl + "vod2_eng.json",
        "EVENT_URL" : baseUrl + "sample.json",
        "COLLECTIONS_BASE_URL" : collectionsBaseUrl
    }
...
function GetVideoItem(video as Object, rowIndex as Integer) as Object
