...
declare let zipFolder: (srcFolder: string, zipFilePath: string, preFileZipCallback?: (file: import("./RokuDeploy").StandardizedFileEntry, data: Buffer) => Buffer) => Promise<void>;
declare let zipPackage: (options: import("./RokuDeployOptions").RokuDeployOptions) => Promise<void>;
export { createPackage, deleteInstalledChannel, deploy, deployAndSignPackage, getDestPath, getFilePaths, getDeviceInfo, getOptions, getOutputPkgFilePath, getOutputZipFilePath, normalizeFilesArray, normalizeRootDir, parseManifest, prepublishToStaging, pressHomeButton, publish, rekeyDevice, retrieveSignedPackage, signExistingPackage, stringifyManifest, zipFolder, zipPackage };
