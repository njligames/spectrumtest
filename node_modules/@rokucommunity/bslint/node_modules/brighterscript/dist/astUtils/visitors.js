...
exports.WalkMode = exports.InternalWalkMode = exports.createVisitor = exports.walk = exports.walkStatements = void 0;
 ...
 */
function walk(keyParent, key, visitor, options, parent) {
    var _a, _b;
    ...
    let element = keyParent[key];
    if (!element) {
        return;
    }
    //notify the visitor of this element
    if (element.visitMode & options.walkMode) {
        const result = visitor(element, parent !== null && parent !== void 0 ? parent : keyParent);
        //replace the value on the parent if the visitor returned a Statement or Expression (this is how visitors can edit AST)
        if (result && (reflection_1.isExpression(result) || reflection_1.isStatement(result))) {
            keyParent[key] = result;
...
function createVisitor(visitor) {
    return ((statement, parent) => {
        var _a;
        return (_a = visitor[statement.constructor.name]) === null || _a === void 0 ? void 0 : _a.call(visitor, statement, parent);
    });
}
