...
export declare class Scope {
    ...
    */
     ...
     */
    getFile(pathAbsolute: string): BrsFile | import(".").XmlFile;
    /**
     * Get the list of files referenced by this scope that are actually loaded in the program.
     * Excludes files from ancestor scopes
     */
    getOwnFiles(): (BrsFile | import(".").XmlFile)[];
    /**
     * Get the list of files referenced by this scope that are actually loaded in the program.
     * Includes files from this scope and all ancestor scopes
     */
    getAllFiles(): (BrsFile | import(".").XmlFile)[];
    /**
    ...
    */
     ...
     * @param relativePath
     */
    protected getFileByRelativePath(relativePath: string): BrsFile | import(".").XmlFile;
    /**
