...
class Lexer {
    ...
    scanToken() {
        ...
        else if (Characters_1.isDecimalDigit(c)) {
    ...
    decimalNumber(hasSeenDecimal) {
        ...
        while (Characters_1.isDecimalDigit(this.peek())) {
            this.advance();
        }
     ...
     */
    hexadecimalNumber() {
        while (Characters_1.isHexDigit(this.peek())) {
            this.advance();
        }
        // fractional hex literals aren't valid
        if (this.peek() === '.' && Characters_1.isHexDigit(this.peekNext())) {
     ...
     */
    identifier() {
        while (Characters_1.isAlphaNumeric(this.peek())) {
            this.advance();
        }
...
Lexer.tokenFunctionMap = {
    ...
    '.': function () {
        ...
        // are allowed
        if (Characters_1.isDecimalDigit(this.peek())) {
