    ...
    describe('parse', () => {
        ...
        describe('comments', () => {
            ...
            it('if statement`', () => {
                ...
                if (astUtils_1.isFunctionStatement(fnSmt)) {
                    let ifStmt = fnSmt.func.body.statements[0];
                    if (astUtils_1.isIfStatement(ifStmt)) {
                        ...
                        if (astUtils_1.isIfStatement(elseIfBranch)) {
                            ...
                            if (astUtils_1.isBlock(elseBranch)) {
...
function expectCommentWithText(stat, text) {
    if (astUtils_1.isCommentStatement(stat)) {
