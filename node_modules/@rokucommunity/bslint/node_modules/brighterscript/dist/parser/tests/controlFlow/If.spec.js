...
describe('parser if statements', () => {
    ...
    it('single-line if block statements have correct range', () => {
        ...
        chai_1.expect(Parser_spec_1.rangeMatch(then1.range, then1.statements)).to.be.true;
        const then2 = statements[1].thenBranch;
        chai_1.expect(Parser_spec_1.rangeMatch(then2.range, then2.statements)).to.be.true;
        const else1 = statements[2].elseBranch;
        chai_1.expect(Parser_spec_1.rangeMatch(else1.range, else1.statements)).to.be.true;
        const else2 = statements[3].elseBranch;
        chai_1.expect(Parser_spec_1.rangeMatch(else2.range, else2.statements)).to.be.true;
    });
});
