...
describe('parser for loops', () => {
    ...
    it('catches unterminated for reaching function boundary', () => {
        ...
        `);
        chai_1.expect(parser.diagnostics).to.be.lengthOf(1);
        chai_1.expect(parser.statements).to.be.lengthOf(1);
        chai_1.expect(parser.references.functionStatements[0].func.body.statements).to.be.lengthOf(1);
    });
