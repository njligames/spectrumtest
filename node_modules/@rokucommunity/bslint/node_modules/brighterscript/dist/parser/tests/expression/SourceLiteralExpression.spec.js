...
describe('SourceLiteralExpression', () => {
    ...
    describe('transpile', () => {
        ...
        it('accounts for sourceRoot in SOURCE_FILE_PATH', () => {
            ...
            `, `
                sub main()
                    print "${fileUrl(util_1.standardizePath `${sourceRoot}/source/main.bs`).substring(0, 4)}" + "${fileUrl(util_1.standardizePath `${sourceRoot}/source/main.bs`).substring(4)}"
                end sub
            `, undefined, 'source/main.bs');
        });
        it('accounts for sourceRoot in SOURCE_LOCATION', () => {
            ...
            `, `
                sub main()
                    print "${fileUrl(util_1.standardizePath `${sourceRoot}/source/main.bs`).substring(0, 4)}" + "${fileUrl(util_1.standardizePath `${sourceRoot}/source/main.bs`).substring(4)}:3"
                end sub
            `, undefined, 'source/main.bs');
        });
    });
