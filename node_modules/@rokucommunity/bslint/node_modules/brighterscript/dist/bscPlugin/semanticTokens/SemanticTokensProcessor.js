...
exports.SemanticTokensProcessor = void 0;
const vscode_languageserver_protocol_1 = require("vscode-languageserver-protocol");
const reflection_1 = require("../../astUtils/reflection");
const parser_1 = require("../../parser");
const util_1 = require("../../util");
class SemanticTokensProcessor {
    constructor(event) {
        this.event = event;
    }
    process() {
        if (reflection_1.isBrsFile(this.event.file)) {
    ...
    processBrsFile(file) {
        ...
        for (const func of file.parser.references.functionExpressions) {
            for (const parm of func.parameters) {
                if (reflection_1.isCustomType(parm.type)) {
                    classes.push({
...
exports.SemanticTokensProcessor = SemanticTokensProcessor;
//# sourceMappingURL=SemanticTokensProcessor.js.map