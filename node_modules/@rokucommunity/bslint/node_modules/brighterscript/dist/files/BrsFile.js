...
class BrsFile {
    ...
    createFunctionScopes() {
        ...
        for (let func of functions) {
            ...
            (_a = func.body) === null || _a === void 0 ? void 0 : _a.walk(visitors_1.createVisitor({
    ...
    getClassFromMReference(position, currentToken, functionScope) {
        ...
        if ((previousToken === null || previousToken === void 0 ? void 0 : previousToken.kind) === lexer_1.TokenKind.Identifier && (previousToken === null || previousToken === void 0 ? void 0 : previousToken.text.toLowerCase()) === 'm' && reflection_1.isClassMethodStatement(functionScope.func.functionStatement)) {
