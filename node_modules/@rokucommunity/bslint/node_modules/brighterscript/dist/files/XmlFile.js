...
class XmlFile {
    ...
    getCommentFlags(tokens) {
        ...
        for (let token of tokens) {
            if (token.tokenType.name === 'Comment') {
                ...
                token.image.replace(/\-\-\>$/, ''), SGParser_1.rangeFromTokenValue(token));
            }
        }
    ...
    validateComponent(ast) {
        ...
        if (!component) {
            //not a SG component
            this.diagnostics.push(Object.assign(Object.assign({}, DiagnosticMessages_1.DiagnosticMessages.xmlComponentMissingComponentDeclaration()), { range: root.range, file: this }));
            return;
        }
        //component name/extends
        if (!component.name) {
            this.diagnostics.push(Object.assign(Object.assign({}, DiagnosticMessages_1.DiagnosticMessages.xmlComponentMissingNameAttribute()), { range: component.tag.range, file: this }));
        }
        if (!component.extends) {
            this.diagnostics.push(Object.assign(Object.assign({}, DiagnosticMessages_1.DiagnosticMessages.xmlComponentMissingExtendsAttribute()), { range: component.tag.range, file: this }));
        }
        //needsTranspiled should be true if an import is brighterscript
        this.needsTranspiled = this.needsTranspiled || component.scripts.some(script => { var _a, _b; return ((_a = script.type) === null || _a === void 0 ? void 0 : _a.indexOf('brighterscript')) > 0 || ((_b = script.uri) === null || _b === void 0 ? void 0 : _b.endsWith('.bs')); });
    ...
    get parentComponent() {
        return this.cache.getOrAdd('parent', () => {
            var _a, _b, _c;
            return (_c = (_b = this.program.getComponent((_a = this.parentComponentName) === null || _a === void 0 ? void 0 : _a.text)) === null || _b === void 0 ? void 0 : _b.file) !== null && _c !== void 0 ? _c : null;
        });
    }
    getHover(position) {
        //TODO implement
    ...
    transpile() {
        var _a, _b;
        const state = new TranspileState_1.TranspileState(this.pathAbsolute, this.program.options);
