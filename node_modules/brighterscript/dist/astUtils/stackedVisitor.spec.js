...
describe('createStackedVisitor', () => {
    ...
    it('visits a well-formed structure', () => {
        ...
        const stackedVisitor = (0, stackedVisitor_1.createStackedVisitor)((item, stack) => {
            (0, chai_1.assert)(item !== undefined, 'item is undefined');
            (0, chai_1.assert)(item.id !== undefined, 'item.id is undefined');
            (0, chai_1.assert)(stack !== undefined, 'stack is undefined');
    ...
    it('calls open/close when visiting the structure', () => {
        ...
        const stackedVisitor = (0, stackedVisitor_1.createStackedVisitor)(() => { }, (pushed, stack) => {
            (0, chai_1.assert)(pushed !== undefined, 'pushed is undefined');
            (0, chai_1.assert)(pushed.id !== undefined, 'pushed.id is undefined');
            (0, chai_1.assert)(stack !== undefined, 'stack is undefined');
            actual.push(`>${stack.map(e => e.id).join('/')}:${pushed.id}`);
        }, (popped, stack) => {
            (0, chai_1.assert)(popped !== undefined, 'popped is undefined');
            (0, chai_1.assert)(popped.id !== undefined, 'popped.id is undefined');
            (0, chai_1.assert)(stack !== undefined, 'stack is undefined');
