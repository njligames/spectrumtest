...
describe('InterfaceType', () => {
    describe('toString', () => {
        it('returns empty curly braces when no members', () => {
            (0, chai_1.expect)(iface({}).toString()).to.eql('{}');
        });
        it('includes member types', () => {
            (0, chai_1.expect)(iface({ name: new StringType_1.StringType() }).toString()).to.eql('{ name: string; }');
        });
    ...
    describe('equals', () => {
        it('matches equal objects', () => {
            (0, chai_1.expect)(iface({ name: new StringType_1.StringType() }).equals(iface({ name: new StringType_1.StringType() }))).to.be.true;
        });
    ...
    describe('isAssignableTo', () => {
        ...
        it('matches properties in mismatched order', () => {
            (0, chai_1.expect)(new InterfaceType_1.InterfaceType(new Map([
                ['name', new StringType_1.StringType()],
                ['age', new IntegerType_1.IntegerType()]
