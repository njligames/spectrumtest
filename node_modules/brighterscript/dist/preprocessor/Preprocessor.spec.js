...
describe('preprocessor', () => {
    ...
    it('forwards brightscript chunk contents unmodified', () => {
        ...
        (0, chai_1.expect)(processedTokens).to.eql(unprocessed);
    });
    describe('#const', () => {
        it('removes #const declarations from output', () => {
            ...
            (0, chai_1.expect)(processedTokens).to.eql([]);
        });
        describe('values', () => {
            it('allows `true`', () => {
                (0, chai_1.expect)(() => new Preprocessor_1.Preprocessor().filter([
    ...
    describe('#if', () => {
        ...
        it('enters #if branch', () => {
            ...
            (0, chai_1.expect)(ifChunk.accept.callCount).to.equal(1);
            (0, chai_1.expect)(elseIfChunk.accept.callCount).to.equal(0);
            (0, chai_1.expect)(elseChunk.accept.callCount).to.equal(0);
        });
        it('enters #else if branch', () => {
            ...
            (0, chai_1.expect)(ifChunk.accept.callCount).to.equal(0);
            (0, chai_1.expect)(elseIfChunk.accept.callCount).to.equal(1);
            (0, chai_1.expect)(elseChunk.accept.callCount).to.equal(0);
        });
        it('enters #else branch', () => {
            ...
            (0, chai_1.expect)(ifChunk.accept.callCount).to.equal(0);
            (0, chai_1.expect)(elseIfChunk.accept.callCount).to.equal(0);
            (0, chai_1.expect)(elseChunk.accept.callCount).to.equal(1);
        });
