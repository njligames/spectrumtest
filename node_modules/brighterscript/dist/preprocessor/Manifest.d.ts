...
export declare type ManifestValue = number | string | boolean;
/** A map containing the data from a `manifest` file. */
export declare type Manifest = Map<string, ManifestValue>;
/**
 ...
 *          representing the manifest file's contents
 */
export declare function parseManifest(contents: string): Map<string, ManifestValue>;
/**
