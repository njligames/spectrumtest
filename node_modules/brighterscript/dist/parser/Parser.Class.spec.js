...
describe('parser class', () => {
    ...
    for (let keyword of TokenKind_1.AllowedProperties) {
        ...
        it(`supports ${keyword} as property name`, () => {
            ...
            (0, chai_1.expect)(statements[0]).instanceof(Statement_1.ClassStatement);
        });
    ...
    it('does not allow "throw" to be defined as a local var', () => {
        ...
        `);
        (0, chai_1.expect)((_a = parser.diagnostics[0]) === null || _a === void 0 ? void 0 : _a.message).to.eql(DiagnosticMessages_1.DiagnosticMessages.unexpectedToken('=').message);
    });
    it('does not allow function named "throw"', () => {
        ...
        `);
        (0, chai_1.expect)((_a = parser.diagnostics[0]) === null || _a === void 0 ? void 0 : _a.message).to.eql(DiagnosticMessages_1.DiagnosticMessages.cannotUseReservedWordAsIdentifier('throw').message);
    });
    ...
    it('bad property does not invalidate next sibling method', () => {
        ...
        (0, chai_1.expect)(classStatement.methods[0]).to.exist;
        (0, chai_1.expect)(classStatement.methods[0].name.text).to.equal('new');
    });
    it('catches class without name', () => {
        ...
        (0, chai_1.expect)(diagnostics[0].code).to.equal(DiagnosticMessages_1.DiagnosticMessages.expectedIdentifierAfterKeyword('class').code);
        (0, chai_1.expect)(statements[0]).instanceof(Statement_1.ClassStatement);
    });
    ...
    describe('fields', () => {
        it('identifies perfect syntax', () => {
            ...
            (0, chai_1.expect)(field.accessModifier.kind).to.equal(TokenKind_1.TokenKind.Public);
            (0, chai_1.expect)(field.name.text).to.equal('firstName');
            (0, chai_1.expect)(field.as.text).to.equal('as');
            (0, chai_1.expect)(field.type.text).to.equal('string');
        });
        it('can be solely an identifier', () => {
            ...
            (0, chai_1.expect)(cls.fields[0].name.text).to.equal('firstName');
        });
        it('malformed field does not impact leading and trailing fields', () => {
            ...
            let cls = statements[0];
            (0, chai_1.expect)(cls.fields[0].name.text).to.equal('firstName');
            (0, chai_1.expect)(cls.fields[cls.fields.length - 1].name.text).to.equal('lastName');
        });
        it(`detects missing type after 'as' keyword`, () => {
            ...
            (0, chai_1.expect)(diagnostics.length).to.be.greaterThan(0);
            let cls = statements[0];
            (0, chai_1.expect)(cls.fields[0].name.text).to.equal('middleName');
            (0, chai_1.expect)(diagnostics[0].code).to.equal(DiagnosticMessages_1.DiagnosticMessages.expectedIdentifierAfterKeyword('as').code);
        });
        it('field access modifier defaults to undefined when omitted', () => {
            ...
            (0, chai_1.expect)(diagnostics).to.be.lengthOf(0);
            let cls = statements[0];
            (0, chai_1.expect)(cls.fields[0].accessModifier).to.be.undefined;
        });
    });
    describe('methods', () => {
        it('recognizes perfect syntax', () => {
            ...
            (0, chai_1.expect)(theClass).to.be.instanceof(Statement_1.ClassStatement);
            let method = theClass.methods[0];
            (0, chai_1.expect)(method.name.text).to.equal('getName');
            (0, chai_1.expect)(method.accessModifier.text).to.equal('public');
            (0, chai_1.expect)(method.func).to.exist;
        });
        ...
        it('method access modifier is undefined when omitted', () => {
            ...
            (0, chai_1.expect)(diagnostics).to.be.lengthOf(0);
            let cls = statements[0];
            (0, chai_1.expect)(cls.methods[0].accessModifier).to.be.undefined;
        });
        it('supports primative field initializers', () => {
            ...
            (0, chai_1.expect)((_a = diagnostics[0]) === null || _a === void 0 ? void 0 : _a.message).not.to.exist;
            let cls = statements[0];
            (0, chai_1.expect)(cls.memberMap['name'].initialValue).to.exist;
            (0, chai_1.expect)(cls.memberMap['age'].initialValue).to.exist;
            (0, chai_1.expect)(cls.memberMap['isalive'].initialValue).to.exist;
            (0, chai_1.expect)(cls.memberMap['callback'].initialValue).to.exist;
        });
        it('detects missing function keyword', () => {
            ...
            (0, chai_1.expect)(diagnostics[0].code).to.equal(DiagnosticMessages_1.DiagnosticMessages.missingCallableKeyword().code);
        });
    });
    it('supports comments in various locations', () => {
        ...
        (0, chai_1.expect)((_a = diagnostics[0]) === null || _a === void 0 ? void 0 : _a.message).to.not.exist;
    });
    it('recognizes the "extends" keyword', () => {
        ...
        (0, chai_1.expect)(stmt.extendsKeyword.text).to.equal('extends');
        (0, chai_1.expect)(stmt.parentClassName.getName(Parser_1.ParseMode.BrighterScript)).to.equal('Person');
    });
    it('catches missing identifier after "extends" keyword', () => {
        ...
        `);
        let { diagnostics } = Parser_1.Parser.parse(tokens, { mode: Parser_1.ParseMode.BrighterScript });
        (0, chai_1.expect)(diagnostics[0].code).to.equal(DiagnosticMessages_1.DiagnosticMessages.expectedIdentifierAfterKeyword('extends').code);
    });
    describe('new keyword', () => {
        it('parses properly', () => {
            ...
            (0, chai_1.expect)(stmt.value).to.be.instanceof(Expression_1.NewExpression);
        });
