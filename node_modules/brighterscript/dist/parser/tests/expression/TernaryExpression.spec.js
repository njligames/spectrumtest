...
describe('ternary expressions', () => {
    it('throws exception when used in brightscript scope', () => {
        ...
        (0, chai_1.expect)((_a = diagnostics[0]) === null || _a === void 0 ? void 0 : _a.message).to.equal(DiagnosticMessages_1.DiagnosticMessages.bsFeatureNotSupportedInBrsFiles('ternary operator').message);
    });
    it('cannot be used as a statement', () => {
        ...
        (0, chai_1.expect)(diagnostics).not.to.be.empty;
    });
    it(`cannot be used as a statement`, () => {
        (0, chai_1.expect)(parseBs(`true ? true : "zombie"`).diagnostics).not.to.be.empty;
        (0, chai_1.expect)(parseBs(`false ? true : "zombie"`).diagnostics).not.to.be.empty;
        (0, chai_1.expect)(parseBs(`len("person") = 10 ? true : "zombie"`).diagnostics).not.to.be.empty;
        (0, chai_1.expect)(parseBs(`m.getResponse() ? true : "zombie"`).diagnostics).not.to.be.empty;
    });
    it(`supports boolean expression condition`, () => {
        ...
        (0, chai_1.expect)(statements[0].value).to.be.instanceof(Expression_1.TernaryExpression);
    ...
    describe('in assignment', () => {
        ...
        it(`in func call with array args`, () => {
            ...
            (0, chai_1.expect)(callExpression.args[0]).instanceof(Expression_1.TernaryExpression);
        });
        ...
        it(`in array`, () => {
            ...
            (0, chai_1.expect)(literalExpression.elements[0]).instanceOf(Expression_1.TernaryExpression);
        ...
        it(`in aa`, () => {
            ...
            (0, chai_1.expect)(literalExpression.elements[0].value).instanceOf(Expression_1.TernaryExpression);
        ...
        it(`in for each`, () => {
            ...
            (0, chai_1.expect)(statements[0].target).instanceof(Expression_1.TernaryExpression);
        });
        it('creates TernaryExpression with missing alternate', () => {
            ...
            (0, chai_1.expect)(expr).to.be.instanceof(Expression_1.TernaryExpression);
            (0, chai_1.expect)(expr).property('alternate').to.be.undefined;
            (0, chai_1.expect)(expr).property('consequent').not.to.be.undefined;
        });
        it('creates TernaryExpression with missing consequent', () => {
            ...
            const expr = statements[0].expressions[0];
            (0, chai_1.expect)(expr).to.be.instanceof(Expression_1.TernaryExpression);
            (0, chai_1.expect)(expr).property('consequent').to.be.undefined;
            (0, chai_1.expect)(expr).property('alternate').not.to.be.undefined;
        });
    });
