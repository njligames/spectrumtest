...
describe('parser primary expressions', () => {
    it('parses numeric literals', () => {
        ...
        (0, chai_1.expect)(statements).to.have.length.greaterThan(0);
    });
    ...
    it('location tracking', () => {
        ...
        (0, chai_1.expect)(statements[0].value.range).to.deep.include(vscode_languageserver_1.Range.create(0, 4, 0, 5));
        (0, chai_1.expect)(statements[1].value.range).to.deep.include(vscode_languageserver_1.Range.create(1, 4, 1, 9));
        (0, chai_1.expect)(statements[2].value.range).to.deep.include(vscode_languageserver_1.Range.create(2, 4, 2, 9));
    });
});
