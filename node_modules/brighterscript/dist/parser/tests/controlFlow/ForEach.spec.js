...
describe('parser foreach loops', () => {
    it('requires a name and target', () => {
        ...
        (0, chai_1.expect)(forEach.item).to.deep.include((0, Parser_spec_1.identifier)('word'));
    ...
    it('location tracking', () => {
        ...
        (0, chai_1.expect)(statements[0].range).deep.include(vscode_languageserver_1.Range.create(0, 0, 2, 7));
    });
});
