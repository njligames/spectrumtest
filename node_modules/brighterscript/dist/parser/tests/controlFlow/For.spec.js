...
describe('parser for loops', () => {
    it('accepts a \'step\' clause', () => {
        ...
        (0, chai_1.expect)(statement.increment).to.be.instanceof(Expression_1.LiteralExpression);
        (0, chai_1.expect)(statement.increment.token.text).to.equal('2');
    });
    it('supports omitted \'step\' clause', () => {
        ...
        (0, chai_1.expect)((_a = diagnostics[0]) === null || _a === void 0 ? void 0 : _a.message).not.to.exist;
        (0, chai_1.expect)(statements[0].increment).not.to.exist;
    });
    it('catches unterminated for reaching function boundary', () => {
        ...
        `);
        (0, chai_1.expect)(parser.diagnostics).to.be.lengthOf(1);
        (0, chai_1.expect)(parser.statements).to.be.lengthOf(1);
        (0, chai_1.expect)(parser.references.functionStatements[0].func.body.statements).to.be.lengthOf(1);
    });
    ...
    it('supports a single trailing colon after the `to` expression', () => {
        ...
        `);
        (0, chai_1.expect)((_a = parser.diagnostics[0]) === null || _a === void 0 ? void 0 : _a.message).to.be.undefined;
    });
    it('location tracking', () => {
        ...
        (0, chai_1.expect)(statements[0].range).to.deep.include(vscode_languageserver_1.Range.create(0, 0, 2, 8));
    });
});
