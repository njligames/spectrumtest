...
describe('parser DimStatement', () => {
    ...
    it('flags missing identifier after dim', () => {
        ...
        (0, chai_1.expect)(dimStatement).to.exist;
        (0, chai_1.expect)(dimStatement.identifier).to.not.exist;
        (0, chai_1.expect)(parser.diagnostics.map(x => x.message)).to.include(DiagnosticMessages_1.DiagnosticMessages.expectedIdentifierAfterKeyword('dim').message);
    });
    it('flags missing left bracket', () => {
        ...
        (0, chai_1.expect)(dimStatement).to.exist;
        (0, chai_1.expect)(dimStatement.openingSquare).to.not.exist;
        (0, chai_1.expect)(parser.diagnostics.map(x => x.message)).to.include(DiagnosticMessages_1.DiagnosticMessages.missingLeftSquareBracketAfterDimIdentifier().message);
    });
    it('flags missing right bracket', () => {
        ...
        //the statement should still exist and have null dimensions
        (0, chai_1.expect)(dimStatement).to.exist;
        (0, chai_1.expect)(dimStatement.closingSquare).to.not.exist;
        (0, chai_1.expect)(parser.diagnostics.map(x => x.message)).to.include(DiagnosticMessages_1.DiagnosticMessages.missingRightSquareBracketAfterDimIdentifier().message);
    });
    it('flags missing expression(s)', () => {
        ...
        //the statement should still exist and have null dimensions
        (0, chai_1.expect)(dimStatement).to.exist;
        (0, chai_1.expect)(dimStatement.dimensions).to.be.empty;
        (0, chai_1.expect)(parser.diagnostics.map(x => x.message)).to.include(DiagnosticMessages_1.DiagnosticMessages.missingExpressionsInDimStatement().message);
    });
});
function validatePass(text, dimStatementIndex, identifierText, dimensionsCount) {
    ...
    (0, chai_1.expect)(dimStatement).to.exist;
    (0, chai_1.expect)(dimStatement.dimToken).to.exist;
    (0, chai_1.expect)(dimStatement.identifier).to.exist;
    (0, chai_1.expect)(dimStatement.identifier.text).to.equal(identifierText);
    (0, chai_1.expect)(dimStatement.openingSquare).to.exist;
    (0, chai_1.expect)(dimStatement.dimensions).to.exist;
    (0, chai_1.expect)(dimStatement.dimensions.length).to.equal(dimensionsCount);
    (0, chai_1.expect)(dimStatement.closingSquare).to.exist;
    (0, chai_1.expect)(dimStatement.range).to.exist;
}
