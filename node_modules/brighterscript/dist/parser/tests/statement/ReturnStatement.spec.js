...
describe('parser return statements', () => {
    it('parses void returns', () => {
        ...
        (0, chai_1.expect)(statements).to.ok;
    });
    it('parses literal returns', () => {
        ...
        (0, chai_1.expect)(diagnostics).to.be.lengthOf(0);
        (0, chai_1.expect)(statements).to.be.ok;
    });
    ...
    it('location tracking', () => {
        ...
        (0, chai_1.expect)(diagnostics).to.be.lengthOf(0);
        (0, chai_1.expect)((_a = statements[0].func.body.statements[0]) === null || _a === void 0 ? void 0 : _a.range).to.exist.and.to.deep.include(vscode_languageserver_1.Range.create(1, 2, 1, 10));
    });
});
