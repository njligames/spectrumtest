...
describe('parser try/catch', () => {
    it('can parse try catch statements', () => {
        ...
        (0, chai_1.expect)(stmt).to.be.instanceof(Statement_1.TryCatchStatement);
        (0, chai_1.expect)((_b = stmt.tryToken) === null || _b === void 0 ? void 0 : _b.text).to.eql('try');
        (0, chai_1.expect)(stmt.tryBranch).to.exist.and.ownProperty('statements').to.be.lengthOf(1);
        (0, chai_1.expect)((_c = stmt.catchToken) === null || _c === void 0 ? void 0 : _c.text).to.eql('catch');
        (0, chai_1.expect)(stmt.exceptionVariable.text).to.eql('e');
        (0, chai_1.expect)(stmt.catchBranch).to.exist.and.ownProperty('statements').to.be.lengthOf(1);
        (0, chai_1.expect)((_d = stmt.endTryToken) === null || _d === void 0 ? void 0 : _d.text).to.eql('end try');
    });
