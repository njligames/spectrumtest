...
describe('parser postfix unary expressions', () => {
    ...
    it('disallows consecutive postfix operators', () => {
        ...
        (0, chai_1.expect)(diagnostics[0]).deep.include({
    ...
    it('disallows postfix \'--\' for function call results', () => {
        ...
        (0, chai_1.expect)(diagnostics).to.be.lengthOf(1);
        (0, chai_1.expect)(diagnostics[0]).to.deep.include(Object.assign({}, DiagnosticMessages_1.DiagnosticMessages.incrementDecrementOperatorsAreNotAllowedAsResultOfFunctionCall()));
    });
    ...
    it('location tracking', () => {
        ...
        (0, chai_1.expect)(statements[0].range).deep.include(vscode_languageserver_1.Range.create(0, 0, 0, 12));
    });
});
