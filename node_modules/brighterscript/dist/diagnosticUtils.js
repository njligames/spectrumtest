...
function getDiagnosticLine(diagnostic, diagnosticLine, colorFunction) {
    ...
    if (diagnostic.range && diagnosticLine) {
        let lineNumberText = chalk_1.default.bgWhite(' ' + chalk_1.default.black((diagnostic.range.start.line + 1).toString()) + ' ') + ' ';
        let blankLineNumberText = chalk_1.default.bgWhite(' ' + chalk_1.default.white('_') + ' ') + ' ';
