...
sub init()
  ...
  m.top.observeField("width", "ap_onSizeChange")
  m.top.observeField("height", "ap_onSizeChange")
  m.top.observeField("control", "ap_onControlChange")
  m.timer.observeField("fire", "ap_onTimerFireChange")
  m.direction = 1
  m.top.frameOffsets = []
  m.currentIndex = 0
end sub
...
sub ap_onControlChange() as void
...
sub ap_onTimerFireChange() as void
